const exampleConfig = [
    ...
    },
    {
        ...
        steps: [
            ...
            { lines: "2", variables: { numbers: "[2, 5, 10, 7, 2]", count: 0 }, description: "2. Call <code>reduce()</code> with initial value <code>0</code>. <code>count</code> starts at 0." },

            // Iteration 1: num = 2
            { lines: "2", range: { text: "count, num" }, variables: { count: 0, num: 2 }, description: "3. First iteration: <code>count</code> (accumulator) is 0, <code>num</code> is 2." },
            { lines: "3", range: { text: "num % 2 === 0" }, variables: { count: 0, num: 2 }, description: "4. Check condition: <code>2 % 2 === 0</code> is <b>true</b>." },
            { lines: "4", range: { text: "return count + 1" }, variables: { count: 0, num: 2 }, description: "5. Return <code>count + 1</code>. We have an even number so we want accumulator to count it. New accumulator value is 1 (0 + 1)." },

            // Iteration 2: num = 5
            { lines: "2", range: { text: "count, num" }, variables: { count: 1, num: 5 }, description: "6. Second iteration: <code>count</code> is now 1, <code>num</code> is 5." },
            { lines: "3", range: { text: "num % 2 === 0" }, variables: { count: 1, num: 5 }, description: "7. Check condition: <code>5 % 2 === 0</code> is <b>false</b>." },
            { lines: "6", range: { text: "return count" }, variables: { count: 1, num: 5 }, description: "8. Return current <code>count</code> (1). We do not have an even number so we return the current accumulator value." },

            // Iteration 3: num = 10
            { lines: "2", range: { text: "count, num" }, variables: { count: 1, num: 10 }, description: "9. Third iteration: <code>count</code> is 1, <code>num</code> is 10." },
            { lines: "3", range: { text: "num % 2 === 0" }, variables: { count: 1, num: 10 }, description: "10. Check condition: <code>10 % 2 === 0</code> is <b>true</b>." },
            { lines: "4", range: { text: "return count + 1" }, variables: { count: 1, num: 10 }, description: "11. Return <code>count + 1</code> (2). We have an even number so we want accumulator to count it. New accumulator value is 2 (1 + 1)." },

            // Iteration 4: num = 7
            { lines: "2", range: { text: "count, num" }, variables: { count: 2, num: 7 }, description: "12. Fourth iteration: <code>count</code> is 2, <code>num</code> is 7." },
            { lines: "3", range: { text: "num % 2 === 0" }, variables: { count: 2, num: 7 }, description: "13. Check condition: <code>7 % 2 === 0</code> is <b>false</b>." },
            { lines: "6", range: { text: "return count" }, variables: { count: 2, num: 7 }, description: "14. Return current <code>count</code> (2). We do not have an even number so we return the current accumulator value." },

            // Iteration 5: num = 2
            { lines: "2", range: { text: "count, num" }, variables: { count: 2, num: 2 }, description: "15. Fifth iteration: <code>count</code> is 2, <code>num</code> is 2." },
            { lines: "3", range: { text: "num % 2 === 0" }, variables: { count: 2, num: 2 }, description: "16. Check condition: <code>2 % 2 === 0</code> is <b>true</b>." },
            { lines: "4", range: { text: "return count + 1" }, variables: { count: 2, num: 2 }, description: "17. Return <code>count + 1</code> (3). We have an even number so we want accumulator to count it. New accumulator value is 3 (2 + 1)." },
